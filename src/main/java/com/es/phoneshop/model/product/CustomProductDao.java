    ...
    public List<Product> searchFor(String productName, String fieldToSort, String orderToSort) {
        synchronized (new SynchronizedObject(productName)) {
            ...
            if (productName == null && fieldToSort == null && orderToSort == null) {
                ...
                Supplier<Stream<String>> streamSupplier = () -> Stream.of(list);
                    productList.forEach(product -> {
                        streamSupplier.get().forEach(word -> {
                            if (word == null || product.getDescription().contains(word)
                    ...
                    return sort.sortProductsList(productList, fieldToSort, orderToSort);
                }
            }
        }
